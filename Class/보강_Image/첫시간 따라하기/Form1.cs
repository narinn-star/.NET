...
namespace Week01
{
    public partial class Form1 : Form
    {
        ...
        protected override void OnPaintBackground(PaintEventArgs e) // 더블버퍼링에서 요게 제일 중요하구만. 그래도 이전 소스에 이것만 추가한다고 해서 안깜빡이는것은 아님. 어차피 foreach문에서 하나씩 다 그려넣는 과정에서 생기는 깜빡임이니깡..
        {
            //base.OnPaintBackground(e);
        }
        private void Form1_Paint_1(object sender, PaintEventArgs e)
        {
            if(B == null || B.Width != ClientSize.Width || B.Height != ClientSize.Height)   //창 크기 조절했을 때 도화지 새로 만들어야하는 거.
            {
            ...
            if(B != null)   //도화지 B에 그려진게 있으면 윈도우 e에 출력을 한다.
            {
